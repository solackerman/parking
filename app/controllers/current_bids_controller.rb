class CurrentBidsController < ApplicationController
  ...
  def index
    ...
    if @over 
      flash[:notice] = "The auction has ended. Congradulations to all the winners!"
    end
  ...
  def create
    ...
    #check data for errors
      ...
      if @your_bid.max_bid <= @top_bidder.bid
        ...
        flash[:success] = "Congratulations! You are the highest bidder for #{@your_bid.parking_spot}."
      end
    end
